...
jinja = {
	"methods": [
		...
		"erpnext_proposals.erpnext_proposals.utils.printing.service_item",
		"erpnext_proposals.erpnext_proposals.utils.printing.section_number",
		...
		"filters": [
			...
			[
				...
				[
					...
					"proposal_frozen_cost_currency",
					"proposal_frozen_cost_source_amount",
					"proposal_frozen_cost_source_currency",
					"proposal_frozen_cost_exchange_rate",
					...
					"proposal_scope_section",
					"proposal_sections",
					"proposal_content_tab",
					"proposal_preview_tab",
					"proposal_preview_html",
					"proposal_sow_print_format",
				],
			],
		],
	},
